...
struct Timer
{
	...
	float elapsed() const
	{
		...
		const auto time_span = chrono::duration_cast<chrono::duration<double>>(t2 - start);
...
public:
	...
	virtual void MouseWheel(float x) = 0;
	virtual void MouseMove(int i, int y) = 0;
	Surface* screen = 0;
	bool bRunning = true;
};
...
#include "engine/collider/collider2D.h"
#include "engine/camera.h"
#include "engine/transform.h"
#include "engine/object.h"
#include "engine/array/dynamicArray.h"
#include "engine/ui/uiElement.h"
#include "engine/ui/text/text.h"
